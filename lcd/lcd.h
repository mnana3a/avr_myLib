...
#define LCD_MODE_CURSOR_RIGHT 0X06
#define LCD_MODE_CURSOR_LEFT 0X07
#define LCD_DISP_OFF 0X08
#define LCD_DISP_ON 0X0E
#define LCD_USE_DDRAM 0X80
...
/*
// these show where we need to set the bit in the db lines to send a code
