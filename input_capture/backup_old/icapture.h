...
// to use it: init the inputCap with 0 as default and then use the autorange function
...
//#define __CAPTURE_GET_PULSE
#define __CAPTURE_GET_PERIOD
#define INTE
#define __PER_INT
...
#define SREG (*((volatile uint8_t * const)(0x5f)))
